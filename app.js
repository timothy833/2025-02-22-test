...
function App() {
  ...
  useEffect(()=>{
    setProducts(products.filter( product => product.category === categoryProduct))
  },[categoryProduct])
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {products.map((product)=><div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col">
